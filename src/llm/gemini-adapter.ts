...
export class GeminiAdapter implements LLMAdapter {
  ...
  private instances = new Map<string, GeminiInstance>();
  ...
  async start(options: StartLLMOptions): Promise<string> {
    ...
    const cliArgs = resolveCliArgs('gemini', this.config.cliArgs);

    const logHeader = `=== Gemini Autonomous Session Starting ===\nInstance ID: ${instanceId}\nWorking Directory: ${workingDirectory}\nStarted: ${new Date().toISOString()}\n========================================\n\n`;
